		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori Demo",
									"targetURL": "#btifioridemofiorideploymentdemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"btifioridemofiorideploymentdemo-display": {
								"semanticObject": "btifioridemofiorideploymentdemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bti.fioridemo.fiorideploymentdemo",
									"url": sap.ui.require.toUrl("bti/fioridemo/fiorideploymentdemo")
								}
							}
						}
					}
